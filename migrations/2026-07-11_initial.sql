...
CREATE TABLE IF NOT EXISTS Loan (
    ...
    memb_id INT REFERENCES Members(memb_id) ON DELETE CASCADE, -- Diagram shows 'memb_id' (Note: could be FK_memb_id but diagram shows this)
...
CREATE TABLE IF NOT EXISTS Test_Questions (
    ...
    question_text TEXT,
    test_teast_id INT REFERENCES Test_Task(PK_test_teast_id) ON DELETE CASCADE, -- Note: Diagram has typo "teast"
...
CREATE INDEX IF NOT EXISTS idx_loan_member_id ON Loan (memb_id);



CREATE UNIQUE INDEX IF NOT EXISTS idx_author_book_unique ON Author_book (author_id, book_id);


CREATE INDEX IF NOT EXISTS idx_notification_member_id ON Notification (memb_id);